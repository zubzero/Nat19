...
.factory("UserData", function($http, $q, CONFIG) {
    var session1 = sessionStorage.getItem("autosave");
    $http({
      method: 'GET',
      url: 'https://naturapp.store/api/user/validate_auth_cookie/?cookie='+session1
    ...
    service.check = function(email) {
        ...
        $http({
            ...
            function(result) {
                ...
                localStorage.setItem('customer', JSON.stringify(user_data));
    ...
    service.makePayment = function() {
        ...
        $http({
            ...
            data: {
                "intent": "order",
                "redirect_urls": {
                    "return_url": "https://naturapp.store/return",
                    "cancel_url": "https://naturapp.store/cancel"
                },
                "payer": {
