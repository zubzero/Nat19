...
.controller('AppCtrl', function($scope, MenuData, BasketData, UserData, Data, MetaData, DealsData) {
...
.controller('PaymentCtrl', function($scope, $ionicModal, $state, UserData, BasketData, MetaData, CONFIG, PAYMENT_CONFIG) {
    ...
    $scope.emailLogin= localStorage.getItem('email');
    // Get meta
    $scope.meta = {};
    MetaData.getProperties().then(
        function(result) {
